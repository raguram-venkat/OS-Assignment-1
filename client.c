...
int main()
{
    ...
    int client_id;
    printf("Enter CLient-ID  (from 1-499): ");
    scanf("%d", &client_id);
    ...
    while (true)
    {
        int choice;
        //strcpy(output, "");
        printf("\n\n1. Enter 1 to contact the Ping Server\n2. Enter 2 to contact the File Search Server (Display file name again if exists... or just skip to main menu)\n3. Enter 3 to contact the File Word Count Server (Along with the  given file name)\n4. Enter 4 if this Client wishes to exit\n");
        printf("\n\nEnter your choice: ");
        scanf("%d", &choice);
        if (choice == 4)
        {
